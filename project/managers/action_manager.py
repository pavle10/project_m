...
class ActionManager:
    ...
    def _update_employee(self, values):
        result = self._database_manager.actions(Actions.update_employee, values)
    ...
    def _update_uniform(self, values):
        result = self._database_manager.actions(Actions.update_uniform, values)

        return result

    def _update_uniform_piece(self, values):
        result = self._database_manager.actions(Actions.update_uniform_piece, values)

        return result

    def _update_free_days(self, values):
        result = self._database_manager.actions(Actions.update_free_days, values)

        return result

    def _update_wage(self, values):
        result = self._database_manager.actions(Actions.update_wage, values)
    ...
    def _delete_employee(self, values):
        result = self._database_manager.actions(Actions.delete_employee, values)
    ...
    def _delete_child(self, values):
        result = self._database_manager.actions(Actions.delete_child, values)

        return result

    def _delete_uniform(self, values):
        result = self._database_manager.actions(Actions.delete_uniform, values)

        return result

    def _delete_uniform_piece(self, values):
        result = self._database_manager.actions(Actions.delete_uniform_piece, values)

        return result

    def _delete_free_days(self, values):
        result = self._database_manager.actions(Actions.delete_free_days, values)

        return result

    def _delete_wage(self, values):
        result = self._database_manager.actions(Actions.delete_wage, values)
