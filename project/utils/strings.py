...
FREE_DAYS_LIST_TITLE = "Spisak slobodnih dana"
WAGE_LIST_TITLE = "Spisak dnevnica zaposlenih"
SALARY_1_LIST_TITLE = "Pregled plata 1 u periodu od {start_date} do {end_date}"
SALARY_2_LIST_TITLE = "Pregled plata 2 u periodu od {start_date} do {end_date}"
